...
function prettyGraphics(kit) {
    ...
    var header = _loadAssetsSync.header;
    var pencil = _loadAssetsSync.pencil;
    var ak = _loadAssetsSync.ak;
    var mp = _loadAssetsSync.mp;
    var proxima = _loadAssetsSync.proxima;
