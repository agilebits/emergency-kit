...
function prettyGraphics(kit) {
    ...
    doc.fillColor("#333").font("Helvetica-Bold").fontSize(14).text("Setup code", 403, 610).moveDown(1).font(proxima).text("Scan this code when setting up 1Password to add your account quickly and easily.", { width: 174 });
