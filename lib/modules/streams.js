...
function createUint8ArrayStream() {
  return new _stream["default"].Transform({
...
_extends(streams, {
  createUint8ArrayStream: createUint8ArrayStream,
  blobFromUint8ArrayStream: blobFromUint8ArrayStream
});

var _default = streams;
